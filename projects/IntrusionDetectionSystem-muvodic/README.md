...
The proposed project is an intrusion detection system that will analyze traffic (TCP packets and their contents) and according to the contents of the package classify the incoming traffic as malicious and will also detect the type of attack. Classification and detection will be done with the help of artificial intelligence. The specific type of model is yet to be defined. If possible the detection system will be implemented into an application as opposed to a bare jupyter notebook. The data used will be a ready dataset. The datasets consist of rows that represent individual TCP packages and columns which represent the different components that make up a TCP packet.

## Hypothesis
The detection system will correctly detect and classify malicious traffic with a satisfactory success rate.

## 👤 Student Information

- **Student Name**: Mariela Uvodic
- **GitHub**: [@manje22](https://github.com/manje22)
